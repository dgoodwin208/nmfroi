...
%Try to get as close as you can to the centroid position, then the code
%finds that ROI and trace for you
...
hold off;
title(['Mask with ' num2str(size(component_centroids,1)) 'filtered components']);
...
title(sprintf('Total plot for ROI index=%i',cluster_idx));
...
% 
% 
% %% Go through all time histories of each ROI, and create a spike chart
